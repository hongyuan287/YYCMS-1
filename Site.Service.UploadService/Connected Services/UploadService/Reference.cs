...
namespace Site.Service.UploadService.UploadService {
    ...
    public interface IUploadService {
        ...
        System.Collections.Generic.List<string> UploadImg(byte[] imgDatas, string configName, System.Collections.Generic.List<string> sizeConfig, string imgExt);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://service.jsonyang.com/IUploadService/UploadImg", ReplyAction="http://service.jsonyang.com/IUploadService/UploadImgResponse")]
        System.Threading.Tasks.Task<System.Collections.Generic.List<string>> UploadImgAsync(byte[] imgDatas, string configName, System.Collections.Generic.List<string> sizeConfig, string imgExt);
    }
    ...
    public partial class UploadServiceClient : System.ServiceModel.ClientBase<Site.Service.UploadService.UploadService.IUploadService>, Site.Service.UploadService.UploadService.IUploadService {
        ...
        public System.Collections.Generic.List<string> UploadImg(byte[] imgDatas, string configName, System.Collections.Generic.List<string> sizeConfig, string imgExt) {
            return base.Channel.UploadImg(imgDatas, configName, sizeConfig, imgExt);
        }
        
        public System.Threading.Tasks.Task<System.Collections.Generic.List<string>> UploadImgAsync(byte[] imgDatas, string configName, System.Collections.Generic.List<string> sizeConfig, string imgExt) {
            return base.Channel.UploadImgAsync(imgDatas, configName, sizeConfig, imgExt);
        }
    }
}
